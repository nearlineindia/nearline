...
//----------------------------------------------------------------- Lights
var ambientLight = new THREE.AmbientLight(0xd100bd, 4);
var lightFront = new THREE.SpotLight(0x7732cf, 20, 10);
var lightBack = new THREE.PointLight(0x7732cf, 0.5);
...
var createCars = function(cScale = 2, cPos = 20, cColor = 0x7732cf) {
